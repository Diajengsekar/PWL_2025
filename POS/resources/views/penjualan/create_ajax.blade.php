        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="penjualan_kode" id="penjualan_kode" class="form-control" value="TRX00" required>
                ...
                <button type="button" class="btn btn-outline-success btn-sm mb-3" id="addRow">+ Tambah Barang</button>
            </div>
